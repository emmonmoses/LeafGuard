...
const resetPassword = async (req, res, model, moduleName) => {
  try {
    ...
    Best Regards <br> treeplanting Support Team <br><br>
    <a href="http://treeplanting.com" target="_blank">
    <img src="http://treeplanting.com/logo.png" alt="treeplanting Logo" style="width: 150px; height: auto;">
    </a><br>
